...
namespace OP
{
    ...
    static void do_op(ASM::InstStr const& inst, Func op)
    {
...
namespace MOV
{
    ...
    static OP::Func get_mov_f(REG::Name reg)
    {
        using R = REG::Name;
...
namespace ADD
{
    ...
    static OP::Func get_add_f(REG::Name reg)
    {
        using R = REG::Name;
